...
import { User, Phone, CreditCard, Calendar, GripVertical } from "lucide-react";
...
const getStatusLabel = (status: string | null) => {
  switch (status) {
    ...
    case "hosted":
    case "hospedado": return "Hospedado";
    case "finished":
...
const getPaymentLabel = (status: string | null) => {
  switch (status) {
    ...
    case "failed": return "Pgto Falhou";
...
const getSourceLabel = (source: string | null) => {
  switch (source) {
    case "site": return "Site Oficial";
    case "whatsapp": return "WhatsApp";
    case "booking": return "Booking.com";
    case "airbnb": return "Airbnb";
    case "agency": return "Agência";
    case "manual": return "Manual";
    default: return source || "Site";
  }
};
...
const DraggableReservationBlock = ({
  reservation,
  startCol,
  span,
  startHalf = false,
      ...
      <TooltipTrigger asChild>
        <div
          ...
          className={cn(
            ...
            !isDragging && isDragEnabled && "cursor-grab hover:scale-[1.02] hover:shadow-lg",
            !isDragEnabled && "cursor-pointer hover:scale-[1.02] hover:shadow-lg"
          )}
          style={{
      ...
      <TooltipContent side="top" className="max-w-xs">
        <div className="space-y-2 p-1">
          ...
          <div className="text-[10px] text-muted-foreground border-t pt-1">
            {isDragEnabled ? "Arraste para mover · Clique para editar" : "Clique para editar"}
          </div>
        </div>
      </TooltipContent>
    </Tooltip>
...
export default DraggableReservationBlock;
