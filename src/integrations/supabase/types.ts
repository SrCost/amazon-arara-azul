    ...
    Tables: {
      ...
      experiences: {
        Row: {
          ...
          duration_label_fr: string
          duration_label_pt: string
          ...
          name_fr: string
          name_pt: string
          operational_notes_de: string
          operational_notes_en: string
          operational_notes_es: string
          operational_notes_fr: string
          operational_notes_pt: string
          photos: string[]
          ...
          slug: string
          updated_at: string
          what_to_bring_de: string
          what_to_bring_en: string
          what_to_bring_es: string
          what_to_bring_fr: string
          what_to_bring_pt: string
          what_to_wear_de: string
          what_to_wear_en: string
          what_to_wear_es: string
          what_to_wear_fr: string
          what_to_wear_pt: string
        }
        Insert: {
          base_price_per_person?: number
          category_de?: string
