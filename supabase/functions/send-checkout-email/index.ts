...
<h1 style="margin:0;font-size:24px;">Como foi sua estadia?</h1>
<p style="margin:8px 0 0;opacity:0.9;font-size:14px;">Adoraríamos saber sua opinião</p>
</td></tr>
<tr><td style="padding:40px;color:#2D3748;font-size:15px;line-height:1.7;">
<p>Olá <strong>${reservation.guest_name}</strong>,</p>
<p>Esperamos que sua experiência na Pousada Arara Azul tenha sido inesquecível! Complete seu check-out digital e compartilhe como foi sua estadia.</p>
<table width="100%"><tr><td align="center" style="padding:24px 0;">
<a href="${checkoutLink}" style="background:#0B3A66;color:#fff;padding:16px 32px;border-radius:10px;text-decoration:none;font-weight:600;display:inline-block;font-size:16px;">
Fazer Check-out
</a></td></tr></table>
...
© ${new Date().getFullYear()} Pousada Arara Azul — Manacapuru, AM
    ...
    const emailRes = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        subject: "🌿 Conte como foi sua estadia — Pousada Arara Azul",
        html,
      }),
    });
